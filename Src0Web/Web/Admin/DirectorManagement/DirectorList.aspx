                                ...
                                <asp:Repeater ID="rptDirectors" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td>
                                                <a class="btn btn-sm btn-success" href="<%# GetRouteUrl("Admin_DirectorDetail", new { id = Eval("ID") }) %>">Chi tiết</a> | 
                                            <a class="btn btn-sm btn-warning" href="<%# GetRouteUrl("Admin_EditDirector", new { id = Eval("ID"), action = "update"}) %>">Sửa</a> | 
