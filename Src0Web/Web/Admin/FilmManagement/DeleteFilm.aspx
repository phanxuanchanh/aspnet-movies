<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/Admin/Layout/AdminLayout.Master" AutoEventWireup="true" CodeBehind="DeleteFilm.aspx.cs" Inherits="Web.Admin.FilmManagement.DeleteFilm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Xóa phim - Trang quản trị</title>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <% if (enableShowResult)
        { %>
    <h5 class="mt-2">Trạng thái xóa phim</h5>
    ...
    <div class="row grid-responsive">
        <div class="column page-heading">
            <div class="large-card">
                <h3>Xóa phim: <% = string.Format("{0} -- {1}", filmInfo.ID, filmInfo.name) %></h3>
