                                ...
                                <asp:Repeater ID="rptCategories" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td>
                                                <a class="btn btn-sm btn-success" href="<%# GetRouteUrl("Admin_CategoryDetail", new { id = Eval("ID") }) %>">Chi tiết</a> | 
                                            <a class="btn btn-sm btn-warning" href="<%# GetRouteUrl("Admin_EditCategory", new { id = Eval("ID"), action = "update"}) %>">Sửa</a> | 
