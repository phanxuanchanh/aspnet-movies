...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
        ...
        <div class="column ">
            <div class="card">
                ...
                <div class="card-block">
                    <asp:GridView ID="grvTag" runat="server" BorderColor="Silver" BorderStyle="Solid" AutoGenerateColumns="False" DataKeyNames="ID" OnSelectedIndexChanged="grvTag_SelectedIndexChanged">
    ...
    <%if (enableTool)
        { %>
    <h5 class="mt-2">Công cụ chỉnh sửa thẻ tag</h5>
    <a class="anchor" name="buttons"></a>
    <p class="mt-2">Bạn đang thao tác trên thẻ tag: <% = toolDetail %></p>
    <div class="row grid-responsive">
        <div class="column">
    ...
    <h5 class="mt-2">Thêm mới thẻ tag</h5>
    <a class="anchor" name="buttons"></a>
    <div class="row grid-responsive">
        <div class="column">
